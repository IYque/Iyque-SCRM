...
#### 开源版与商业版区别
【商业版】是基于SpringCloud微服务架构,企微生态打造的全链路SCRM解决方案，不仅整合了全域获客、客户精细管理、精准销售转化、数据洞察等核心功能模块，还提供专属部署、定制开发、技术支持等企业级服务，能深度适配企业从获客到留存的全业务流程，满足规模化运营需求；

【开源版】则基于SpringBoot单体架构,以企微开放API为基础，聚焦轻量化实用小工具，功能更偏向碎片化辅助，解决局部效率问题，无配套系统性深度服务支撑。
...
源雀SCRM基于源码100%开放的策略，积极拥抱开源，目前已推出了一个完全开源、免费使用的源雀SCRM开源版工具，结合智谱AI等AI大模型，让企业快速拥有更强大、更丰富、更智能的企业微信管理能力。
...
**客户标签**
- 便于多维度的管理企业标签。为后续客户画像功能提供基础数据;

**内容**
- **普通素材**：管理员在PC后台统一管理企业标准素材（文字、图片、图文链接），员工在企业微信移动端快速查找并发送给客户，确保信息一致性与沟通效率;
- **组合话术**： 管理员在PC后台统一设置企业通用话术（文字、图片、图文链接），员工在企业微信移动端快速查找并发送给客户，确保信息一致性与沟通效率。

**客服**
- **排班客服**：智能管理客户接入与客服接待时效，提升服务精准度

**配置**
- **操作日志**：查看企微管理员|普通成员的操作日志，便于问题追溯
- **群机器人**：企业微信群机器人是集成于企业内部群的自动化消息推送工具，支持通过API或配置化方式向指定群组发送通知、告警及业务消息，实现高效协同与信息同步
- **文件安全**: 通过智能检测+日志追溯双机制，为企业核心数据资产构建“事前预警-事中记录-事后溯源”的全链路防护体系
- **截屏安全**: 通过行为监测+智能追溯的双重机制，为企业构建覆盖"行为发现-过程记录-责任定位"的全流程数据保护屏障
### 5.2 AI功能

目前源雀SCRM开源版结合智谱AI等大模型，实现客户会话相关能力智能化，具体如下：
...
- **AI会话总结**:通过AI大模型自动分析客户与客服之间的对话记录，生成简明扼要的总结报告，帮助管理人员快速把握服务要点，提升服务质量与效率。



 **AI客户会话**
- **会话内容**: 拉取员工与客户的文本聊天内容。
- **AI会话预审**: 结合智谱AI对员工发送给客户指定时间聊天内容进行ai分析,判断员工是否有敲单,辱骂客户,向客户索要回扣红包等行为。
...
- **AI会话预审**: 结合智谱AI对员工发送给客群指定时间聊天内容进行ai分析,判断员工在群中是否有相关违规等行为。
...
![img.png](img/j-3.jpg)
## 七、获奖荣耀
   <a href="https://iyuanque.cn/#awards" target="_blank">项目获奖荣耀</a>
