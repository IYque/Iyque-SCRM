...
**AI 智能助手**
- **AI营销通用营销助手**: 基于大模型协助用户做营销策划
- **AI智能导航**: 根据用户场景描述，自动推荐功能引导
...
**AI智能标签库**
- **AI客户标签**: 通过描述相关需求，让大模型规划企业客户标签。
- **AI客群标签**: 通过描述相关需求，让大模型规划企业客群标签。
...
-  ruoyi-ai: 参考其知识库相关功能。
-  langchain4j: Java生态的LLM应用开发框架，简化AI集成。
